...
rows = [
 ("Buthe & Mattli (2011)",
  ...
  "Supported",
  "Kept. Now also grounds the setter/contextualiser/taker vocabulary (see Blind row)."),
 ("Yates & Murphy (2019)",
  "A century of rule-making in which de facto global norms emerge without formal imposition.",
  "Engineering Rules: the first global history of voluntary consensus standard-setting since 1880; committee standards become de facto global norms.",
  "Tightened",
  "Reworded to 'voluntary consensus standard-setting'; removed the 'market incumbency' gloss the source does not stress."),
 ("Blind (2013)",
  "Original draft: a 'typology of standardisation strategies' supplying the setter/contextualiser/taker vocabulary.",
  "Blind gives a fourfold typology of standards FUNCTIONS (compatibility, quality, variety reduction, information), not a typology of setter/taker strategies.",
  "Misattributed",
  "Corrected. Blind now cited for the functional typology; the setter/contextualiser/taker vocabulary is reattributed to the power asymmetry in Buthe & Mattli (2011). NB: the same misattribution appears in the thesis (Ch 6.1.3) and should be fixed there too."),
 ("Bradford (2020)",
